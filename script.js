...
const quizData = {
    ...
    "network": {
        ...
        questions: [
            {
                question: "Que signifie l'acronyme OSI ?",
                options: ["Open System Interconnection", "Open Source Initiative", "Operating System Interface", "Online Service Integration"],
                correct: 0,
                explanation: "Le modèle OSI (Open Systems Interconnection) est un modèle en 7 couches pour les réseaux."
            },
            {
                question: "Quelle couche du modèle OSI est responsable du routage ?",
                options: ["Physique", "Liaison de données", "Réseau", "Transport"],
                correct: 2,
                explanation: "La couche Réseau (couche 3) gère le routage entre réseaux."
            },
            {
                question: "Quel protocole est utilisé pour attribuer des adresses IP automatiquement ?",
                options: ["DNS", "DHCP", "FTP", "SMTP"],
                correct: 1,
                explanation: "Le DHCP assigne dynamiquement des adresses IP aux hôtes sur un réseau."
            },
            {
                question: "Quel port TCP est utilisé par défaut pour HTTP ?",
                options: ["80", "443", "21", "25"],
                correct: 0,
                explanation: "Le port 80 est le port par défaut pour HTTP non chiffré."
            },
            {
                question: "Que fait le DNS ?",
                options: ["Crypte les données", "Associe noms de domaine à adresses IP", "Gère les certificats", "Surveille le trafic réseau"],
                correct: 1,
                explanation: "Le DNS résout des noms de domaine en adresses IP pour la communication réseau."
            }
        ]
    }
};
